    ...
    return (
        <Formik
            ...
            validationSchema={object().shape({
                email: string()
                    .max(191, 'E-mailadresser må ikke overstige 191 tegn.')
                    .email('Der skal angives en gyldig e-mailadresse.')
                    .required('Der skal angives en gyldig e-mailadresse.'),
                ...
                {!isRootAdmin && loggedInPermissions[0] !== '*' && (
                    <div css={tw`mt-4 pl-4 py-2 border-l-4 border-cyan-400`}>
                        <p css={tw`text-sm text-neutral-300`}>
                            Kun tilladelser, som din konto er tildelt i øjeblikket, kan vælges ved oprettelse eller
                            ændring af andre brugere.
                        </p>
                    </div>
                )}
                {!subuser && (
                    <div css={tw`mt-6`}>
                        <Field
                            ...
                            label={'Bruger e-mail'}
                            description={
                                'Indtast e-mailadressen på den bruger, du ønsker at invitere til denne server.'
                            }
                        />
                    </div>
                )}
