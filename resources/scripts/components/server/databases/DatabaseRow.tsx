            ...
            <Formik onSubmit={submit} initialValues={{ confirm: '' }} validationSchema={schema} isInitialValid={false}>
                {({ isSubmitting, isValid, resetForm }) => (
                    ...
                    >
                        ...
                        <h2 css={tw`text-2xl mb-6`}>Bekræft sletning af database</h2>
                        <p css={tw`text-sm`}>
                            Sletning af en database er en permanent handling, den kan ikke fortrydes. Dette slettes permanent
                            <strong>{database.name}</strong>-databasen og fjern alle tilknyttede data.
                        </p>
                        <Form css={tw`m-0 mt-6`}>
                            <Field
                                ...
                                id={'confirm_name'}
                                name={'confirm'}
                                label={'Bekræft databasenavn'}
                                description={'Indtast databasenavnet for at bekræfte sletningen.'}
                            />
