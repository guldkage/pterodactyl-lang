    ...
    return (
        <form id={'enable-totp-form'} onSubmit={submit}>
            ...
            <p id={'totp-code-description'} className={'mt-6'}>
                Scan QR-koden ovenfor ved hjælp af den to-trins godkendelsesapp efter eget valg. Indtast derefter det 6-cifrede
                kode genereret i feltet nedenfor.
            </p>
            <Input.Text
            ...
            <Dialog.Footer>
                ...
                <Tooltip
                    ...
                    content={
                        !token
                            ? 'Venter på, at QR-koden indlæses...'
                            : 'Du skal indtaste den 6-cifrede kode og din adgangskode for at fortsætte.'
                    }
                    delay={100}
                >
                    <Button
...
export default asDialog({
    title: 'Aktiver totrinsbekræftelse',
    description:
        "Hjælp med at beskytte din konto mod uautoriseret adgang. Du bliver bedt om en bekræftelseskode, hver gang du logger ind.",
