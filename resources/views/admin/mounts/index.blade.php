...
@section('content-header')
    <h1>Mounts<small>Konfigurer og administrer yderligere monteringspunkter til servere.</small></h1>
    <ol class="breadcrumb">
                    ...
                    <table class="table table-hover">
                        <tbody>
                            <tr>
                                ...
                                <th class="text-center">Maskiner</th>
                                <th class="text-center">Servere</th>
                            </tr>
            ...
            <div class="modal-content">
                <form action="{{ route('admin.mounts') }}" method="POST">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">Opret Mount</h4>
                    </div>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <p class="text-muted small">Unikt navn, der bruges til at adskille denne montering fra en anden.</p>
                            </div>

                            <div class="col-md-12">
                                <label for="pDescription" class="form-label">Beskrivelse</label>
                                <textarea id="pDescription" name="description" class="form-control" rows="4"></textarea>
                                <p class="text-muted small">En længere beskrivelse af denne montering skal være på mindre end 191 tegn.</p>
                            </div>

                            <div class="col-md-6">
                                <label for="pSource" class="form-label">Kilde</label>
                                <input type="text" id="pSource" name="source" class="form-control" />
                                <p class="text-muted small">Filsti på systemet for at montere til en container.</p>
                            </div>

                            <div class="col-md-6">
                                <label for="pTarget" class="form-label">Mål</label>
                                <input type="text" id="pTarget" name="target" class="form-control" />
                                <p class="text-muted small">Hvor mounten vil være tilgængelig inde i en container.</p>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div>
                                    <div class="radio radio-success radio-inline">
                                        ...
                                        <label for="pReadOnlyFalse">Nej</label>
                                    </div>

                                    <div class="radio radio-warning radio-inline">
                                        <input type="radio" id="pReadOnly" name="read_only" value="1">
                                        <label for="pReadOnly">Ja</label>
                                    </div>
                                </div>

                                <p class="text-muted small">Er mounten læsbar inde i beholderen?</p>
                            </div>

                            <div class="col-md-6">
                                <label class="form-label">Brugermonterbar</label>

                                <div>
                                    <div class="radio radio-success radio-inline">
                                        <input type="radio" id="pUserMountableFalse" name="user_mountable" value="0" checked>
                                        <label for="pUserMountableFalse">Nej</label>
                                    </div>

                                    <div class="radio radio-warning radio-inline">
                                        <input type="radio" id="pUserMountable" name="user_mountable" value="1">
                                        <label for="pUserMountable">Ja</label>
                                    </div>
                                </div>

                                <p class="text-muted small">Skal brugerne selv kunne administere denne mount?</p>
                            </div>
                        </div>
                    </div>
