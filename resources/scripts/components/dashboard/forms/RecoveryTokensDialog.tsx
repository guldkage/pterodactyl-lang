...
export default ({ tokens, open, onClose }: RecoveryTokenDialogProps) => {
    ...
    return (
        <Dialog
            ...
            description={
                'Gem koderne nedenfor et sikkert sted. Hvis du mister adgangen til din telefon, kan du bruge disse backupkoder til at logge ind.'
            }
            hideCloseIcon
        ...
        >
            ...
            Disse koder vil ikke blive vist igen.
            </Alert>
            <Dialog.Footer>
                <Button.Text onClick={onClose}>Færdig</Button.Text>
            </Dialog.Footer>
        </Dialog>
    );
};
