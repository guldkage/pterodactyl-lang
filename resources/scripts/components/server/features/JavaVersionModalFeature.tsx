...
const JavaVersionModalFeature = () => {
    ...
    return (
        ...
        >
            ...
            <h2 css={tw`text-2xl mb-4 text-neutral-100`}>Ikke-understøttet Java-version</h2>
            <p css={tw`mt-4`}>
                Denne server kører i øjeblikket en ikke-understøttet version af Java og kan ikke startes.
                <Can action={'startup.docker-image'}>
                    &nbsp;Vælg venligst en understøttet version fra listen nedenfor for at fortsætte med at starte serveren.
                </Can>
            </p>
            <Can action={'startup.docker-image'}>
                <div css={tw`mt-4`}>
